...
describe HashTree do
  ...
  describe HashTree::Map do
    ...
    let!(:lvl2) { HashTree::Map.new(lvl1, "LVL2") }
    let!(:lvl3) { HashTree::Map.new(lvl2, "LVL3") }
    let!(:lvl4_1) { HashTree::Map.new(lvl3, "LVL4_1") }
    let!(:lvl4_2) { HashTree::Map.new(lvl3, "LVL4_2") }
    let!(:lvl4_3) { HashTree::Map.new(lvl3, "LVL4_3") }
    ...
    describe "#ancestors" do 
      it "returns a list of ancestors"
    end
    describe "#dot" do
      it "looks up a path and return the matching node" do
        expect(root.dot("")).to be root
    ...
    describe "#<=>" do
      it "compares the nodes recursively"
    end
    describe "#to_s" do
